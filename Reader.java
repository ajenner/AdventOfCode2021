...
public class Reader {
    ...
    public ArrayList<Instruction> readEachInstruction() {
        ArrayList<Instruction> inputList = new ArrayList<>();
        try {
            Scanner scanner = new Scanner(this.file);
            while (scanner.hasNext()) {
                String[] line = scanner.nextLine().split(" ");
                inputList.add(new Instruction(line[0], Integer.parseInt(line[1])));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
